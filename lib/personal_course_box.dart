...
class PersonalCourseBox extends StatelessWidget {
              ...
              child: Stack(
                children: [
                  Container(
                    ...
                    height:
                        (MediaQuery.of(context).size.height) - height3 * 0.66,
                    ...
                    child: Container(
                      ...
                      child: Row(
                        ...
                        children: <Widget>[
                          ...
                          Icon(Icons.person,
                              size: height3 * 0.021, color: Color(0xFF707070)),
                          SizedBox(
                          ...
                          Icon(Icons.star,
                              size: height3 * 0.021, color: Colors.white),
                          Icon(Icons.star,
                              size: height3 * 0.021, color: Colors.white),
                          Icon(Icons.star,
                              size: height3 * 0.021, color: Colors.white),
                  ...
                  Container(
                    width: MediaQuery.of(context).size.width,
                    height:
                        (MediaQuery.of(context).size.height) - height3 * 0.80,
                    decoration: new BoxDecoration(
