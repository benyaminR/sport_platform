...
class ChallengeComment extends Equatable{
  final String text;
  ...
  ChallengeComment({@required this.text, @required this.thumbnail, @required this.user, @required this.username, @required this.media, @required this.date, @required this.verificationData, @required this.comments, @required this.likes, @required this.shares});
  @override
