...
@singleton
class AddCoursesUseCase extends UseCase<CourseData,WithParams>{

  final CoursesRepo repo;

  AddCoursesUseCase({@required this.repo});

  CourseData get courseData => null;


  @override
  Future<Either<Failure, CourseData>> call(WithParams params) => repo.addCourse(courseData);
}