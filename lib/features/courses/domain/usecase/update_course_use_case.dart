...
@singleton
class UpdateCourseUseCase extends UseCase<Course,WithParams>{

  final CoursesRepo repo;

  UpdateCourseUseCase({@required this.repo});

  @override
  Future<Either<Failure, Course>> call(WithParams params) => repo.updateCourse(params.param as Course);
}