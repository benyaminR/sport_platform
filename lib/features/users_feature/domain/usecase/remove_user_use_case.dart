...
class RemoveUserUseCase extends UseCase<User,WithParams>{

  final UsersRepo repo;

  RemoveUserUseCase({@required this.repo});


  @override
  Future<Either<Failure, User>> call(WithParams params) => repo.removeUser(params.param);
}