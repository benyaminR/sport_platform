    ...
    return BlocProvider.value(
      ...
      child: BlocBuilder<CoursesBloc, CoursesState>(
        builder: (context, state) {
          ...
          if (state is LoadingCoursesState) return CircularProgressIndicator();
          if (state is ErrorCoursesState) return Text(state.msg);
          return Container();
        },
      ),
    );
        ...
        child: Container(
          ...
          child: ListView(
            ...
            children: <Widget>[
              ...
              BlocProvider.value(
                value: getIt<StorageBloc>()
                  ..add(GetDownloadUrlEvent(
                      path: course.content[0].videos[0].source)),
                child: BlocBuilder<StorageBloc, StorageState>(
                  builder: (context, state) {
                    ...
                    if (state is StorageError) return Text(state.msg);
              ...
              BlocProvider.value(
                value: getIt<CourseDetailViewTabsBloc>()..add(ContentTab()),
                child: BlocBuilder<CourseDetailViewTabsBloc,
                    CourseDetailViewTabsState>(
                  builder: (context, state) {
                    ...
                    if (state is ReviewsTabState)
                      return CourseDetailViewReviewsWidget(
